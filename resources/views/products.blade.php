...
<body><amp-sidebar id="sidebar" class="cid-r0O1EfDCHp" layout="nodisplay" side="right">
		<div class="builder-sidebar" id="builder-sidebar">
			...
			<span></span>
				...
				<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
						<a class="nav-link mbr-bold link text-black display-7" href="">Minecraft Hosting<br></a> 
  ...
  <section class="menu1 menu horizontal-menu cid-r0O1EfDCHp" id="menu1-1z">
	...
	<nav class="navbar navbar-dropdown navbar-expand-lg navbar-fixed-top">
		<div class="menu-container container">
			...
			<div class="navbar-brand">
				...
				<span class="navbar-caption-wrap"><a class="navbar-caption mbr-bold text-black display-5" href="{{route('index')}}">Reflex Hosting</a></span>
			</div>
			<!-- SHOW LOGO END -->
			<!-- COLLAPSED MENU -->
...
<section class="header1 cid-syePBSvSfZ" id="header1-25">
    
    <div class="mbr-overlay"></div>
    <div class="container">
        <div class="mbr-row align-center">
            <div class="title-block mbr-col-sm-12 mbr-col-md-12 mbr-col-lg-12">
                <h1 class="mbr-section-title mbr-fonts-style mbr-bold display-1">Minecraft Hosting</h1>
                <h2 class="mbr-section-subtitle mbr-fonts-style mbr-pt-3 display-2">Budget Mid tier and premium&nbsp;</h2>
...
<section class="pricing-table1 cid-syePV06zSy" id="pricing-table1-26">
	

	
	<div class="container">
            <div class="title-block mbr-pb-4 align-center">
                <h3 class="mbr-section-title mbr-black mbr-bold mbr-fonts-style display-2">Budget Hosting</h3>
		...
		<div class="mbr-row mbr-jc-c">
			<div class="card card1 mbr-col-sm-12 mbr-col-md-6 md-pb mbr-col-lg-4 align-center">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">1gb Server</h3>
					</div>
					...
					<div class="items-list-wrap">
						...
						<li class="list-item">
								...
								<span class="item-text mbr-fonts-style display-7">Pterodactyl Panel</span>
							</li><li class="list-item">
								
								<span class="item-text mbr-fonts-style display-7">Unlimited plugins</span>
							</li><li class="list-item">
								
								<span class="item-text mbr-fonts-style display-7">Unlimited player slots</span>
							</li></ul>
					</div>
					<div class="card-button mbr-section-btn"><a href="{{route('configure')}}" class="btn btn-lg btn-primary display-7">Configure</a></div>
				</div>
			</div>
			...
			<div class="card card2 mbr-col-sm-12 mbr-col-md-6 md-pb mbr-col-lg-4 align-center">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">2gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
			...
			<div class="card card3 mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 align-center last-child">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">3gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
...
<section class="pricing-table1 cid-syeQOXGlh6" id="pricing-table1-27">
	

	
	<div class="container">
            <div class="title-block mbr-pb-4 align-center">
                <h3 class="mbr-section-title mbr-black mbr-bold mbr-fonts-style display-2">Mid tier Hosting</h3>
		...
		<div class="mbr-row mbr-jc-c">
			<div class="card card1 mbr-col-sm-12 mbr-col-md-6 md-pb mbr-col-lg-4 align-center">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">4gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
			...
			<div class="card card2 mbr-col-sm-12 mbr-col-md-6 md-pb mbr-col-lg-4 align-center">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">5gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
			...
			<div class="card card3 mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 align-center last-child">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">6gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
...
<section class="pricing-table1 cid-syeRFGcWPO" id="pricing-table1-28">
	

	
	<div class="container">
            <div class="title-block mbr-pb-4 align-center">
                <h3 class="mbr-section-title mbr-black mbr-bold mbr-fonts-style display-2">Premium Hosting</h3>
		...
		<div class="mbr-row mbr-jc-c">
			<div class="card card1 mbr-col-sm-12 mbr-col-md-6 md-pb mbr-col-lg-4 align-center">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">7gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
			...
			<div class="card card2 mbr-col-sm-12 mbr-col-md-6 md-pb mbr-col-lg-4 align-center">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">8gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
			...
			<div class="card card3 mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4 align-center last-child">
				<div class="card-inner">
					...
					<div class="card-head">
						<h3 class="card-title mbr-black mbr-fonts-style display-5">9gb Server</h3>
					</div>
					<div class="card-price-wrap">
						<div class="card-price">
							<span class="price-sign mbr-black mbr-fonts-style display-2">$</span>
