...
<head>
    ...
    <style amp-custom>
        ...
        *:focus {
        ...
        .cid-r0O1EfDCHp .navbar {
            background: #ffffff;
        }

        .cid-r0O1EfDCHp .navbar-caption {
            line-height: inherit;
        }

        @media (max-width: 991px) {
            .cid-r0O1EfDCHp .navbar .navbar-collapse {
                background: #ffffff;
            }
        }

        .cid-r0O1EfDCHp .nav-link {
            margin: .667em 1em;
            padding: 0;
        }

        .cid-r0O1EfDCHp .dropdown-item.active, .cid-r0O1EfDCHp .dropdown-item:active {
            background-color: transparent;
        }

        .cid-r0O1EfDCHp .dropdown-menu {
            background: #ffffff;
        }

        .cid-r0O1EfDCHp .hamburger span {
            background-color: #232323;
        }

        .cid-r0O1EfDCHp .builder-sidebar {
            background-color: #ffffff;
        }

        .cid-r0O1EfDCHp .close-sidebar:focus {
            outline: 2px auto #4e84c2;
        }

        .cid-r0O1EfDCHp .close-sidebar span {
            background-color: #232323;
        }
        ...
        .cid-r89gzwx5mR {
            ...
            background-image: url("{{asset("images/background4-h_kp14pqyn.jpg")}}");
            align-items: center;
            display: flex;
        }

        .cid-r89gzwx5mR .mbr-overlay {
            background: #000000;
            opacity: 0.5;
        }

        .cid-r89gzwx5mR .mbr-section-title, .cid-r89gzwx5mR .mbr-section-btn {
            color: #ffffff;
        }

        .cid-r89gzwx5mR .mbr-section-subtitle, .cid-r89gzwx5mR .mbr-section-btn {
            color: #ffffff;
        }
        ...
        .cid-r0O1Lmz0xf mbr-section-title {
            color: #000000;
        }

        .cid-r0O1Lmz0xf mbr-section-subtitle {
            color: #000000;
        }

        .cid-r0O1Lmz0xf card-title {
            color: #000000;
        }

        .cid-r0O1Lmz0xf card-subtitle {
            color: #000000;
        }

        .cid-r0O1Lmz0xf card-text {
            color: #000000;
        }
        ...
        .cid-r89mu6mCfS .card-wrapper {
            background: #f7f7f7;
        }

        @media (min-width: 768px) {
            .cid-r89mu6mCfS .card-box {
                padding-left: 2rem;
            }
        }
