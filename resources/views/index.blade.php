...
<head>
  ...
  <link rel="shortcut icon" href="images/66574161_padded_logo_128x128.png" type="image/x-icon">
...
<link href="https://s.googleapis.com/css?family=Didact+Gothic&subset=cyrillic" rel="stylesheet">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-8 mbr-col-lg-4 align-center md-pb">
                <div class="card-wrapper mbr-flex mbr-column mbr-p-4">
                    ...
                    <div class="card-box">
                        ...
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">Cheapest prices from 1.25 per gb</p>
    ...
    <div class="container">
        ...
        <div class="mbr-row mbr-jc-c mbr-pt-4">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <p class="review mbr-fonts-style display-7">The support responded instantly when i needed help!</p>
                <p class="name mbr-fonts-style mbr-bold mbr-pt-3 display-7">- jamz 2143</p>
                <p class="subtitle mbr-fonts-style mbr-bold mbr-pt-1 display-7">Customer</p>
            </div>
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <p class="review mbr-fonts-style display-7">I had no lag with 30 people on, great serviece!</p>
                <p class="name mbr-fonts-style mbr-bold mbr-pt-3 display-7">- big mamith&nbsp;</p>
                <p class="subtitle mbr-fonts-style mbr-bold mbr-pt-1 display-7">Director</p>
            </div>
        </div>
    </div>
</section>
...
<path d="M3.333 8c-0.667 0-0.911 0.861-0.371 1.221l10.663 7.329c0.653 0.449 1.442 0.783 2.374 0.783s1.727-0.335 2.38-0.783l10.663-7.329c0.736-0.498-0.082-1.568-0.755-1.098l-10.663 7.329c-0.505 0.347-0.999 0.548-1.625 0.548s-1.114-0.201-1.619-0.548l-10.663-7.329c-0.11-0.078-0.25-0.12-0.384-0.122zM2 5.333c-1.096 0-2 0.904-2 2v17.333c0 1.096 0.904 2 2 2h28c1.096 0 2-0.904 2-2v-17.333c0-1.096-0.904-2-2-2zM2 6.667h28c0.381 0 0.667 0.286 0.667 0.667v17.333c0 0.381-0.286 0.667-0.667 0.667h-28c-0.381 0-0.667-0.286-0.667-0.667v-17.333c0-0.381 0.286-0.667 0.667-0.667z"></path>
                    ...
                    <div class="card-box mbr-pt-3">
                        <h4 class="card-title mbr-bold mbr-fonts-style display-5">Email&nbsp;</h4>
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">Support@reflexhosting.co.uk</p>
                    </div>
                </div>
            </div>
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-6 align-center last-child">
                <div class="card-wrapper mbr-flex mbr-column">
                    ...
                    <div class="card-box mbr-pt-3">
                        <h4 class="card-title mbr-bold mbr-fonts-style display-5">Discord</h4>
                        <p class="card-text mbr-fonts-style mbr-pt-2 display-7">https://discord.gg/DTnTyw5QQU</p>
                    </div>
                </div>
            </div>
